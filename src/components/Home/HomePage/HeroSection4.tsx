      ...
      <div className="content flex flex-col gap-8 w-1/2 items-center lg:items-start">
        ...
        <div>
          <p className="font-inter text-base text-background text-center lg:text-left">
            ...
            elementum.flex-col Ultrices mattis sed vitae mus risus. Lacus nisi,
        ...
        <div className="icons flex gap-[33px]">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-background font-inter md:text-[18px] width-[50px] h-[50px]  leading-[26px]">
              Fast Food
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-background font-inter md:text-[18px] md:leading-[26px]">
              Lunch
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-background font-inter md:text-[18px] leading-[26px]">
              Dinner
            </p>
          </div>
        </div>
        ...
        <div className="bg-background border-l-8 border-primary flex rounded-md md:px-10 md:py-5 gap-12 lg:w-[374px] lg:h-[93px] w-auto h-auto ">
          <p className="text-primary font-helvetica text-5xl font-bold leading-[56px]">
            30+
          </p>
          <div>
