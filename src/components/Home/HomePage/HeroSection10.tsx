  ...
  return (
    <div className="lg:mb-[120px] mb-20 h-auto md:h-[558px] relative">
      ...
      <div className="w-full h-full">
        <Image
          src="/Images/Hero9 Image.png" // Local path for the background image
          alt="Hero Background"
      ...
      <div className="flex flex-col lg:gap-8 md:gap-6 gap-4 absolute w-auto lg:w-2/5 text-right right-[50px] lg:right-[155px] top-0 md:top-[100px]">
        ...
        <div className="flex gap-6 items-center md:justify-end justify-center">
          {/* Read More Button */}
          <div>
            <button className="border-primary rounded-[30px] bg-transparent text-background border md:px-10 md:py-[16px] px-6 py-[8px]">
              Read More
            </button>
          </div>
          ...
          <div className="flex gap-3 items-center justify-center">
            <Image
              src="/Images/Play.png" // Local path for play button icon
              alt="Play Button"
              className="h-[40px] w-[40px] md:w-full md:h-full"
              width={40}
              height={40}
            />
